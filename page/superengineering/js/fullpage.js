        $(document).ready(function () {
            ...
            $('#fullpage').fullpage({
                ...
                menu: '#menu',
                lockAnchors: false,
                anchors: ['firstPage', 'secondPage', 'thirdPage', 'fourthPage', 'fivePage'], //url后面的部分
                navigation: false,
                ...
                sectionsColor: ['#ff5f45', '#0798ec', '#fc6c7c', '#fec401', '#fc6c7c'],
                paddingTop: '0em',
                paddingBottom: '40px',
                ...
                onLeave: function (origin, destination, direction) {
                    ...
                    if (destination.index == 3) {
                        $(".progress.blue .progress-left .progress-bar").css("webkitAnimation", "");
                        $(".progress.blue .progress-left .progress-bar").css("webkitAnimation", "loading-2 1.5s linear forwards 1.8s");
                    }
